    ...
    //                jQuery('div[id^="fwin_dialog_"]').remove();
                ...
                if (isHtml) {
                    ...
                    if (!opts.title && !btnOk && !btnCancel) {
                        ...
                        dialogHtmlArr.push('<div class="popDialog" style="z-index:' + dialogZIndex +';" id="' + dialogId + '"><span class="close"></span>');
                        //dialogHtmlArr.push('<div class="popDialog" style="width:90%">');
                        dialogHtmlArr.push('<div class="editTitle"><strong>' + title + '</strong></div>');
                        dialogHtmlArr.push('<div class="editTCon">' + content + '</div>');
